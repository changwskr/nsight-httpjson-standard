...
> **상세 문서:** 모든 Gradle 모듈·도구에 `README.md`가 있습니다. ([모듈 목록](#2-프로젝트-구조)) 이 문서는 **전체 개요·빠른 시작·참조표** 역할을 합니다.
...
├── common-web/           → README.md
├── cc-service … om-service/   # 17개 업무 WAR — 각 README.md
├── common-etc/           → README.md (ET)
├── common-updownload/    → README.md (UD)
├── demo-ui/              → README.md
├── bin/                  → README.md
├── scripts/              → README.md
├── ztomcat/              → README.md
...
| 구분 | 모듈 | README |
|------|------|--------|
| 공통 라이브러리 | [`common-core`](common-core/README.md), [`common-web`](common-web/README.md) | ✓ |
| 업무 서비스 (17) | [`cc-service`](cc-service/README.md) … [`om-service`](om-service/README.md) | ✓ |
| 공통 WAR | [`common-etc`](common-etc/README.md), [`common-updownload`](common-updownload/README.md) | ✓ |
| 데모 | [`demo-ui`](demo-ui/README.md) | ✓ |

업무 모듈 README 링크:

| 코드 | README | 코드 | README |
|------|--------|------|--------|
| CC | [cc-service](cc-service/README.md) | PD | [pd-service](pd-service/README.md) |
| IC | [ic-service](ic-service/README.md) | CM | [cm-service](cm-service/README.md) |
| PC | [pc-service](pc-service/README.md) | EB | [eb-service](eb-service/README.md) |
| BC | [bc-service](bc-service/README.md) | EP | [ep-service](ep-service/README.md) |
| MS | [ms-service](ms-service/README.md) | BP | [bp-service](bp-service/README.md) |
| SV | [sv-service](sv-service/README.md) | BD | [bd-service](bd-service/README.md) |
| — | — | SS | [ss-service](ss-service/README.md) |
| — | — | CS | [cs-service](cs-service/README.md) |
| — | — | CT | [ct-service](ct-service/README.md) |
| — | — | MG | [mg-service](mg-service/README.md) |
| — | — | OM | [om-service](om-service/README.md) |
