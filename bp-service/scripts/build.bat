...
set "TASKS=:common-core:build :common-web:build :bp-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\bp.war"
echo.
...
echo   build.bat        Build bp-service bp.war
