...
set "TASKS=:common-core:build :common-web:build :cs-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\cs.war"
echo.
...
echo   build.bat        Build cs-service cs.war
