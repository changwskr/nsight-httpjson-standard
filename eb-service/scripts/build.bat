...
set "TASKS=:common-core:build :common-web:build :eb-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\eb.war"
echo.
...
echo   build.bat        Build eb-service eb.war
