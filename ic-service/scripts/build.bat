...
set "TASKS=:common-core:build :common-web:build :ic-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\ic.war"
echo.
...
echo   build.bat        Build ic-service ic.war
