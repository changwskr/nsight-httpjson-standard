...
set "TASKS=:common-core:build :common-web:build :mg-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\mg.war"
echo.
...
echo   build.bat        Build mg-service mg.war
