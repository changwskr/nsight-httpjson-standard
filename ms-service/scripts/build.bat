...
set "TASKS=:common-core:build :common-web:build :ms-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\ms.war"
echo.
...
echo   build.bat        Build ms-service ms.war
