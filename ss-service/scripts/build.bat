...
set "TASKS=:common-core:build :common-web:build :ss-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\ss.war"
echo.
...
echo   build.bat        Build ss-service ss.war
