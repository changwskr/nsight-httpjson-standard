...
set "TASKS=:common-core:build :common-web:build :sv-service:bootWar"
...
set "OUT_FILE=!PROJECT_HOME!\!MODULE!\build\libs\sv.war"
echo.
...
echo   build.bat        Build sv-service sv.war
